...
def connect_to_sql_server(server: str, database: str, client_id: str, client_secret: str) -> pyodbc.Connection:
    connection_string = (
...
connection = connect_to_sql_server(server, database, client_id, client_secret)
